...
public class MovieAnalyzerLocalTest {
    ...
    static void setUp() {
        ...
        try {
            ...
            System.out.println(movieAnalyzerClass.getName());
            checkDeclarations();
            ...
            imdbTop = constructor.newInstance("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/imdb_top_500.csv\n");
    ...
    @Test
    public void testGetMovieCountByYearWithoutOrder() {
        try {
            movieAnalyzerClass = Class.forName("MovieAnalyzer");
            Constructor<?> constructor = movieAnalyzerClass.getDeclaredConstructor(String.class);
            imdbTop = constructor.newInstance("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/imdb_top_500.csv");
            ...
            String expected = Files.readString(Paths.get("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/answers_local/Q1.txt"),
                            StandardCharsets.UTF_8)
                    .replace("\r", "").strip();
            assertTrue(compareMapWithoutOrder(res, expected, 1));
        } catch (NoSuchMethodException | InvocationTargetException | IllegalAccessException | IOException | InstantiationException | ClassNotFoundException e) {
            e.printStackTrace();
            fail();
        }
    }
    ...
    @Test
    public void testGetMovieCountByYearWithOrder() {
        try {
            movieAnalyzerClass = Class.forName("MovieAnalyzer");
            Constructor<?> constructor = movieAnalyzerClass.getDeclaredConstructor(String.class);
            imdbTop = constructor.newInstance("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/imdb_top_500.csv");
    ...
    @Test
    public void testGetMovieCountByGenreWithoutOrder() {
        try {
            movieAnalyzerClass = Class.forName("MovieAnalyzer");
            Constructor<?> constructor = movieAnalyzerClass.getDeclaredConstructor(String.class);
            imdbTop = constructor.newInstance("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/imdb_top_500.csv");
            ...
            Object res = method.invoke(imdbTop);
            assertTrue(res instanceof Map<?, ?>);
            String expected = Files.readString(Paths.get("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/answers_local/Q2.txt"),
                            StandardCharsets.UTF_8)
                    .replace("\r", "").strip();
    ...
    @Test
    public void testGetMovieCountByGenreWithOrder() {
        try {
            movieAnalyzerClass = Class.forName("MovieAnalyzer");
            Constructor<?> constructor = movieAnalyzerClass.getDeclaredConstructor(String.class);
            imdbTop = constructor.newInstance("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/imdb_top_500.csv");
    ...
    @Test
    public void testGetCoStarCount() {
        try {
            movieAnalyzerClass = Class.forName("MovieAnalyzer");
            Constructor<?> constructor = movieAnalyzerClass.getDeclaredConstructor(String.class);
            imdbTop = constructor.newInstance("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/imdb_top_500.csv");
            ...
            String expected = Files.readString(Paths.get("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/answers_local/Q3.txt"),
                            StandardCharsets.UTF_8)
                    .replace("\r", "").strip();
    ...
    @Test
    public void testGetTopMoviesRuntimeWithoutOrder() {
        try {
            movieAnalyzerClass = Class.forName("MovieAnalyzer");
            Constructor<?> constructor = movieAnalyzerClass.getDeclaredConstructor(String.class);
            imdbTop = constructor.newInstance("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/imdb_top_500.csv");
            ...
            String expected1 = Files.readString(Paths.get("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/answers_local/Q4_1.txt"),
                            StandardCharsets.UTF_8)
                    .replace("\r", "").strip();
            ...
            String expected2 = Files.readString(Paths.get("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/answers_local/Q4_2.txt"),
                            StandardCharsets.UTF_8)
                    .replace("\r", "").strip();
            ...
            String expected3 = Files.readString(Paths.get("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/answers_local/Q4_3.txt"),
                            StandardCharsets.UTF_8)
                    .replace("\r", "").strip();
    ...
    @Test
    public void testGetTopMoviesOverviewWithoutOrder() {
        try {
            movieAnalyzerClass = Class.forName("MovieAnalyzer");
            Constructor<?> constructor = movieAnalyzerClass.getDeclaredConstructor(String.class);
            imdbTop = constructor.newInstance("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/imdb_top_500.csv");
            ...
            assertTrue(res1 instanceof List<?>);
            String expected1 = Files.readString(Paths.get("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/answers_local/Q4_4.txt"),
                            StandardCharsets.UTF_8)
                    .replace("\r", "").strip();
            assertTrue(compareListWithoutOrder(res1, expected1));
            Object res2 = method.invoke(imdbTop, 50, "overview");
            assertTrue(res2 instanceof List<?>);
            String expected2 = Files.readString(Paths.get("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/answers_local/Q4_5.txt"),
                            StandardCharsets.UTF_8)
                    .replace("\r", "").strip();
            assertTrue(compareListWithoutOrder(res2, expected2));
            Object res3 = method.invoke(imdbTop, 100, "overview");
            assertTrue(res3 instanceof List<?>);
            String expected3 = Files.readString(Paths.get("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/answers_local/Q4_6.txt"),
                            StandardCharsets.UTF_8)
                    .replace("\r", "").strip();
            assertTrue(compareListWithoutOrder(res3, expected3));
        } catch (NoSuchMethodException | IllegalAccessException | InvocationTargetException | IOException | ClassNotFoundException | InstantiationException e) {
    ...
    @Test
    public void testGetTopMoviesRuntimeWithOrder() {
        try {
            movieAnalyzerClass = Class.forName("MovieAnalyzer");
            Constructor<?> constructor = movieAnalyzerClass.getDeclaredConstructor(String.class);
            imdbTop = constructor.newInstance("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/imdb_top_500.csv");
    ...
    @Test
    public void testGetTopMoviesOverviewWithOrder() {
        try {
            movieAnalyzerClass = Class.forName("MovieAnalyzer");
            Constructor<?> constructor = movieAnalyzerClass.getDeclaredConstructor(String.class);
            imdbTop = constructor.newInstance("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/imdb_top_500.csv");
    ...
    @Test
    public void testGetTopStarsRatingWithoutOrder() {
        try {
            movieAnalyzerClass = Class.forName("MovieAnalyzer");
            Constructor<?> constructor = movieAnalyzerClass.getDeclaredConstructor(String.class);
            imdbTop = constructor.newInstance("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/imdb_top_500.csv");
            ...
            assertTrue(res1 instanceof List<?>);
            String expected1 = Files.readString(Paths.get("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/answers_local/Q5_1.txt"),
                            StandardCharsets.UTF_8)
                    .replace("\r", "").strip();
            assertTrue(compareListWithoutOrder(res1, expected1));
            Object res2 = method.invoke(imdbTop, 40, "rating");
            assertTrue(res2 instanceof List<?>);
            String expected2 = Files.readString(Paths.get("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/answers_local/Q5_2.txt"),
                            StandardCharsets.UTF_8)
                    .replace("\r", "").strip();
            assertTrue(compareListWithoutOrder(res2, expected2));
            Object res3 = method.invoke(imdbTop, 80, "rating");
            assertTrue(res3 instanceof List<?>);
            String expected3 = Files.readString(Paths.get("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/answers_local/Q5_3.txt"),
                            StandardCharsets.UTF_8)
                    .replace("\r", "").strip();
            assertTrue(compareListWithoutOrder(res3, expected3));
        } catch (NoSuchMethodException | IllegalAccessException | InvocationTargetException | IOException | ClassNotFoundException | InstantiationException e) {
    ...
    @Test
    public void testGetTopStarsGrossWithoutOrder() {
        try {
            movieAnalyzerClass = Class.forName("MovieAnalyzer");
            Constructor<?> constructor = movieAnalyzerClass.getDeclaredConstructor(String.class);
            imdbTop = constructor.newInstance("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/imdb_top_500.csv");
            ...
            assertTrue(res1 instanceof List<?>);
            String expected1 = Files.readString(Paths.get("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/answers_local/Q5_4.txt"),
                            StandardCharsets.UTF_8)
                    .replace("\r", "").strip();
            assertTrue(compareListWithoutOrder(res1, expected1));
            Object res2 = method.invoke(imdbTop, 40, "gross");
            assertTrue(res2 instanceof List<?>);
            String expected2 = Files.readString(Paths.get("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/answers_local/Q5_5.txt"),
                            StandardCharsets.UTF_8)
                    .replace("\r", "").strip();
            assertTrue(compareListWithoutOrder(res2, expected2));
            Object res3 = method.invoke(imdbTop, 80, "gross");
            assertTrue(res3 instanceof List<?>);
            String expected3 = Files.readString(Paths.get("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/answers_local/Q5_6.txt"),
                            StandardCharsets.UTF_8)
                    .replace("\r", "").strip();
            assertTrue(compareListWithoutOrder(res3, expected3));
        } catch (NoSuchMethodException | IllegalAccessException | InvocationTargetException | IOException | ClassNotFoundException | InstantiationException e) {
    ...
    @Test
    public void testGetTopStarsRatingWithOrder() {
        try {
            movieAnalyzerClass = Class.forName("MovieAnalyzer");
            Constructor<?> constructor = movieAnalyzerClass.getDeclaredConstructor(String.class);
            imdbTop = constructor.newInstance("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/imdb_top_500.csv");
    ...
    @Test
    public void testGetTopStarsGrossWithOrder() {
        try {
            movieAnalyzerClass = Class.forName("MovieAnalyzer");
            Constructor<?> constructor = movieAnalyzerClass.getDeclaredConstructor(String.class);
            imdbTop = constructor.newInstance("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/imdb_top_500.csv");
    ...
    public void searchMoviesTest() {
        try {
            ...
            assertTrue(res1 instanceof List<?>);
            String expected1 = Files.readString(Paths.get("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/answers_local/Q6_1.txt"),
                            StandardCharsets.UTF_8)
                    .replace("\r", "").strip();
            assertTrue(compareListWithoutOrder(res1, expected1));
            assertEquals(expected1, listToString(res1));
            ...
            assertTrue(res2 instanceof List<?>);
            String expected2 = Files.readString(Paths.get("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/answers_local/Q6_2.txt"),
                            StandardCharsets.UTF_8)
                    .replace("\r", "").strip();
            assertTrue(compareListWithoutOrder(res2, expected2));
            assertEquals(expected2, listToString(res2));
            ...
            assertTrue(res3 instanceof List<?>);
            String expected3 = Files.readString(Paths.get("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/answers_local/Q6_3.txt"),
                            StandardCharsets.UTF_8)
                    .replace("\r", "").strip();
            assertTrue(compareListWithoutOrder(res3, expected3));
            assertEquals(expected3, listToString(res3));
            ...
            String expected4 = Files.readString(Paths.get("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/answers_local/Q6_4.txt"),
                            StandardCharsets.UTF_8)
                    .replace("\r", "").strip();
            assertEquals(expected4, listToString(res4));
            Object res5 = method.invoke(imdbTop, "Action", 7.7f, 200);
            assertTrue(res5 instanceof List<?>);
            String expected5 = Files.readString(Paths.get("/Users/chenwenyan/IdeaProjects/Java2_A1/src/main/resources/answers_local/Q6_5.txt"),
                            StandardCharsets.UTF_8)
                    .replace("\r", "").strip();
            assertTrue(compareListWithoutOrder(res5, expected5));
            assertEquals(expected5, listToString(res5));
        } catch (InvocationTargetException | NoSuchMethodException | IllegalAccessException | IOException | ClassNotFoundException | InstantiationException e) {
            e.printStackTrace();
            fail();
        }
    }
